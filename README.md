...
Ce projet a été développé avec le soutien et le financement de la Fondation Mastercard dans le cadre des initiatives d'entrepreneuriat et d'innovation de l'UM6P
...
3.Configurations des variables d'environnement 
  Créer un fichier .env dans le dossier server :
    MONGO_URI=votre_mongodb_uri
    JWT_SECRET=votre_secret_key
    PORT=5000
4.Lancer le projet 
    # Dans le dossier client (Frontend)
    npm run dev
